...
const conditionTxt = document.querySelector(".conditon-txt");
...
const apiKey = "821b3b61706a9abcef5338851ccc389b";
...
async function updateWeatherInfo(city) {
  ...
  weatherSummaryImg.src = `./Material/weather/${getWeatherIcon(id)}`;
...
function updateForeCastItems(weatherData) {
  ...
  const forcastItem = `
            <div class="forecast-item">
                ...
                <img src="./Material/weather/${getWeatherIcon(id)}" class="forecast-item-img">
